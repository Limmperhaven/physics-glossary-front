  ...
  <div class="wrapper" v-if="!isItemsLoading">
    ...
    <div class="list">
      <div class="legend">
        ...
        <span style="flex: 2">Explicación en español</span>
        <span style="flex: 2">Explicación en ruso</span>
      </div>
  ...
  methods: {
    async fetch() {
      ...
      this.items = [...JSON.parse(JSON.stringify(
          await definitionsAPI.getDefinitionsList('esp', this.page, 'dynamics'))).rows]
      console.log('+')
